...
public class RestAssuredConfig implements Config {
     ...
     * {@link MatcherConfig}, {@link HeaderConfig}, {@link MultiPartConfig}, {@link CSRFCookieToHeaderConfig}
     */
    public RestAssuredConfig(RedirectConfig redirectConfig,
        ...
        configs.put(CSRFCookieToHeaderConfig.class, csrfCookieToHeaderConfig);
    }
    ...
    public RestAssuredConfig redirect(RedirectConfig redirectConfig) {
        ...
        return new RestAssuredConfig(redirectConfig, conf(HttpClientConfig.class), conf(LogConfig.class), conf(EncoderConfig.class),
                ...
                conf(CSRFCookieToHeaderConfig.class));
    }
    ...
    public RestAssuredConfig multiPartConfig(MultiPartConfig multiPartConfig) {
        ...
        return new RestAssuredConfig(conf(RedirectConfig.class), conf(HttpClientConfig.class), conf(LogConfig.class), conf(EncoderConfig.class),
                ...
                multiPartConfig, conf(ParamConfig.class), conf(OAuthConfig.class), conf(FailureConfig.class), conf(CSRFCookieToHeaderConfig.class));
    }
    ...
    public RestAssuredConfig paramConfig(ParamConfig paramConfig) {
        ...
        return new RestAssuredConfig(conf(RedirectConfig.class), conf(HttpClientConfig.class), conf(LogConfig.class), conf(EncoderConfig.class),
                conf(DecoderConfig.class), conf(SessionConfig.class), conf(ObjectMapperConfig.class), conf(ConnectionConfig.class),
                conf(JsonConfig.class), conf(XmlConfig.class), conf(SSLConfig.class), conf(MatcherConfig.class), conf(HeaderConfig.class),
                conf(MultiPartConfig.class), paramConfig, conf(OAuthConfig.class), conf(FailureConfig.class), conf(CSRFCookieToHeaderConfig.class));
    }
    ...
    public RestAssuredConfig oauthConfig(OAuthConfig oauthConfig) {
        ...
        return new RestAssuredConfig(conf(RedirectConfig.class), conf(HttpClientConfig.class), conf(LogConfig.class), conf(EncoderConfig.class),
                conf(DecoderConfig.class), conf(SessionConfig.class), conf(ObjectMapperConfig.class), conf(ConnectionConfig.class),
                conf(JsonConfig.class), conf(XmlConfig.class), conf(SSLConfig.class), conf(MatcherConfig.class), conf(HeaderConfig.class),
                conf(MultiPartConfig.class), conf(ParamConfig.class), oauthConfig, conf(FailureConfig.class), conf(CSRFCookieToHeaderConfig.class));
    }
    ...
    public RestAssuredConfig failureConfig(FailureConfig failureConfig) {
        ...
        return new RestAssuredConfig(conf(RedirectConfig.class), conf(HttpClientConfig.class), conf(LogConfig.class), conf(EncoderConfig.class),
                conf(DecoderConfig.class), conf(SessionConfig.class), conf(ObjectMapperConfig.class), conf(ConnectionConfig.class),
                conf(JsonConfig.class), conf(XmlConfig.class), conf(SSLConfig.class), conf(MatcherConfig.class), conf(HeaderConfig.class),
                conf(MultiPartConfig.class), conf(ParamConfig.class), conf(OAuthConfig.class), failureConfig, conf(CSRFCookieToHeaderConfig.class));
    }
     ...
     * @return An updated RestAssuredConfiguration
     */
    public RestAssuredConfig csrfCookieToHeaderConfig(CSRFCookieToHeaderConfig csrfCookieToHeaderConfig) {
        notNull(csrfCookieToHeaderConfig, CSRFCookieToHeaderConfig.class);
        return new RestAssuredConfig(conf(RedirectConfig.class), conf(HttpClientConfig.class), conf(LogConfig.class), conf(EncoderConfig.class),
                conf(DecoderConfig.class), conf(SessionConfig.class), conf(ObjectMapperConfig.class), conf(ConnectionConfig.class),
                conf(JsonConfig.class), conf(XmlConfig.class), conf(SSLConfig.class), conf(MatcherConfig.class), conf(HeaderConfig.class),
                conf(MultiPartConfig.class), conf(ParamConfig.class), conf(OAuthConfig.class), conf(FailureConfig.class), csrfCookieToHeaderConfig);
    }
    /**
     * Syntactic sugar.
     *
     ...
     */
    public CSRFCookieToHeaderConfig getCSRFCookieToHeaderConfig() { return conf(CSRFCookieToHeaderConfig.class); }
